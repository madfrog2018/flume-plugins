...
import com.pxene.TanxBidding.BidRequest.*;
...
public class TanxTcpSourceUtils {
    ...
    private static final Logger logger = LoggerFactory
            .getLogger(TanxTcpSourceUtils.class);
    ...
    public TanxTcpSourceUtils() {
        this(false);
    }

    public TanxTcpSourceUtils(boolean isUdp) {
        this(DEFAULT_SIZE, SyslogSourceConfigurationConstants.DEFAULT_KEEP_FIELDS, isUdp);
    }

    public TanxTcpSourceUtils(Integer eventSize, boolean keepFields, boolean isUdp) {
        this.isUdp = isUdp;
        isBadEvent = false;
