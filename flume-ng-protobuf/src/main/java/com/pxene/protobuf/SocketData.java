...
//			}
            ...
            if (userVertical.isEmpty()) {
				...
				sBuilder.append(getSubString(userVerticalStringBuilder)).append("|");
			}
            ...
            if (userAttributeList.isEmpty()) {
				...
				for (UserAttribute userAttribute : userAttributeList) {
					...
					userAtrributeIdBuilder.append(userAttribute.getId()).append(new Character((char)0x01));
					userAtrributeTimestampBuilder.append(userAttribute.getTimestamp()).append(new Character((char)0x01));
				}
				
				sBuilder.append(getSubString(userAtrributeIdBuilder)).append("|");
				sBuilder.append(getSubString(userAtrributeTimestampBuilder)).append("|");
